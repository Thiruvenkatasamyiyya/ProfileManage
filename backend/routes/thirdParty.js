...
import { accessToken, codeGenerate, createClientUrl, deleteClient, findClientID } from '../controllers/thirdPartyController.js';
...
router.post('/oauth/delete',isAuthenticated, deleteClient);
